...
export function getModelList(category) {
...
export function purchaseUpgrade(state, upgrade, type) {
...
export function unlockFunding(state, funding) {
...
export function startResearch(state, category, index) {
...
export function updateResearch(state, deltaSeconds) {
  if (!state.activeResearch) {
    state.computeUsed = 0;
    return;
  }
...
export function updateEconomy(state, deltaSeconds) {
...
export function pushNews(state, message) {
...
export function getInfrastructure(state) {
...
export function getAvailableFunding(state) {
